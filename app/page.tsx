...
export default function Home() {
  ...
  // Handler to toggle action item status in DB and UI
  ...
  // Handler to sync group using Gemini API and update DB
  const handleSyncGroup = async (groupId: string) => {
    ...
    try {
      ...
      // 3. Refresh groups from database to sync all relationships (topics, action items)
